    ...
    public static async Task SeedData(AppDbContext context)
    {
        ...
        var meetups = new List<Meetup>
        {
            new() {
                ...
                Description = "Meetup 2 months ago",
                Category = "drinks",
                City = "London",
            ...
            new() {
                ...
                Description = "Meetup 1 month ago",
                Category = "culture",
                City = "Paris",
            ...
            new() {
                Title = "Future Meetup 1",
                Date = DateTime.Now.AddMonths(1),
                Description = "Meetup 1 month in future",
                Category = "culture",
                City = "London",
            ...
            new() {
                Title = "Future Meetup 2",
                Date = DateTime.Now.AddMonths(2),
                Description = "Meetup 2 months in future",
                Category = "music",
                City = "London",
                Venue = "The O2",
            ...
            new()
            {
                Title = "Future Meetup 3",
                Date = DateTime.Now.AddMonths(3),
                Description = "Meetup 3 months in future",
                Category = "drinks",
                City = "London",
                Venue = "The Mayflower",
                Latitude = 51.501778,
            ...
            new()
            {
                Title = "Future Meetup 4",
                Date = DateTime.Now.AddMonths(4),
                Description = "Meetup 4 months in future",
                Category = "drinks",
                City = "London",
            ...
            new()
            {
                Title = "Future Meetup 5",
                Date = DateTime.Now.AddMonths(5),
                Description = "Meetup 5 months in future",
                Category = "culture",
                City = "London",
            ...
            new()
            {
                Title = "Future Meetup 6",
                Date = DateTime.Now.AddMonths(6),
                Description = "Meetup 6 months in future",
                Category = "music",
                City = "London",
            ...
            new()
            {
                Title = "Future Meetup 8",
                Date = DateTime.Now.AddMonths(8),
                Description = "Meetup 8 months in future",
                Category = "film",
                City = "London",
                Venue = "River Thames, England, United Kingdom",
                Latitude = 51.5575525,
        ...
        context.Meetups.AddRange(meetups);
